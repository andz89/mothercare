...
<div class="container-sm my-3" style="min-height:700px;">
  ...
  <form class="row g-3" action="<?php echo URLROOT; ?>/admin/payment?patient_id=<?php echo $data['patient_id'] ?>&id=<?php echo $_GET['id'] ?>&date=<?php echo $data['booking_date'] ?>" method="POST">
    <h3>Payment</h3>
    <div class="col-md-4">
